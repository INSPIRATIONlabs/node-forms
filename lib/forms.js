...
exports.getField = function(fieldname, form) {
  var levels = fieldname.replace(/\[((.)*?)\]/g, ".$1").split(".");
  var obj = form;
  while (obj != null && levels[0]) {
    obj = obj.fields[levels.shift()];
    if (obj == null) obj = "";
  }
  return obj;
}

exports.create = function (fields, opt) {
    opt = opt || {};
    ...
    f.bind = function (data) {
            ...
            b.isValid = function () {
                var form = this;
                return form._isValid;
            };
            return b;
        };
    f.handle = function (obj, callbacks) {
